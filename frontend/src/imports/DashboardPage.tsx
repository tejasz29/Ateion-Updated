    ...
    <div className="dashboard">
      ...
      <aside className="sidebar">
        <div className="logo" onClick={() => navigate("/")}>
          <img src={logo} alt="Ateion Logo" className="w-[100px] h-[30px] object-contain invert-[1] brightness-200" />
        </div>
        ...
        <ul>
          ...
          <li onClick={() => navigate("/PlayGround")}>
            <span className="sidebar-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"></rect><path d="M6 12h4"></path><path d="M8 10v4"></path><circle cx="15" cy="13" r="1"></circle><circle cx="17" cy="11" r="1"></circle></svg>
            </span> 
            Playground
          </li>
          {/* DISABLED VOUCH LINK */}
      ...
      <main className="main-content">
        ...
        >
          ...
          >
            <div className="card-glow"></div>
            <div className="card-icon-container">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"></rect><path d="M6 12h4"></path><path d="M8 10v4"></path><circle cx="15" cy="13" r="1"></circle><circle cx="17" cy="11" r="1"></circle></svg>
            </div>
            <h2>Playground</h2>
