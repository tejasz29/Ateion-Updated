          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
              <div className="text-right hidden md:block">
                <p className="text-sm font-bold text-[var(--color-text-primary)]">{userProfile.fullName}</p>
                <p className="text-xs text-[var(--color-text-tertiary)]">{userProfile.isPremium ? "Premium Member" : "Free Member"}</p>
              </div>
              <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-purple-400 to-pink-400 border-2 border-[#ffffff] shadow-sm overflow-hidden flex items-center justify-center text-[#ffffff] font-bold text-lg">
          ...
          <div className="max-w-6xl mx-auto flex flex-col gap-8">
            ...
            {activeView === "Dashboard" && (
              <>
                ...
                <div className="relative w-full rounded-[24px] bg-gradient-to-r from-[#6b46c1] to-[#f472b6] p-8 sm:p-10 text-[#ffffff] shadow-lg overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-2 text-[#ffffff]/90 mb-2 font-medium">
                      <Sparkles size={18} />
                    ...
                    <p className="text-[#ffffff]/80 max-w-xl mb-8 text-sm sm:text-base leading-relaxed font-['Inter',sans-serif]">
                    ...
                    <div className="flex flex-wrap gap-4">
                      <button className="bg-[#ffffff] text-[#6b46c1] px-6 py-2.5 rounded-full font-bold shadow-md hover:scale-105 transition-transform flex items-center gap-2">
                        Resume Learning <ChevronRight size={18} />
                      </button>
                      <button className="bg-[#ffffff]/20 text-[#ffffff] border border-[#ffffff]/30 px-6 py-2.5 rounded-full font-bold hover:bg-[#ffffff]/30 transition-colors flex items-center gap-2">
                ...
                <div className="flex flex-col gap-4 mt-6">
                  <h3 className="text-xl font-bold text-[var(--color-text-primary)]" style={{ fontFamily: "'OV Soge', sans-serif" }}>Overview</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    <div className="bg-[var(--color-background-secondary)] rounded-[20px] overflow-hidden shadow-sm border border-[var(--color-border-light)] flex flex-col group hover:shadow-md transition-all cursor-pointer">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        <h4 className="text-[16px] font-bold text-[var(--color-text-primary)] mb-1 line-clamp-2">Advanced React & TypeScript</h4>
                        <p className="text-xs text-[var(--color-text-tertiary)] mb-4">Sarah Johnson</p>
                        <div className="mt-auto">
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-xs font-bold text-[var(--color-text-tertiary)]">Progress</span>
                            <span className="text-xs font-bold text-[var(--color-text-primary)]">67% Complete</span>
                          </div>
                          ...
                          <p className="text-xs text-[var(--color-text-secondary)] font-medium mb-4">16 of 24 lessons completed</p>
                          <button className="w-full bg-[#1e1632] hover:bg-[#2d245a] text-[#ffffff] py-2.5 rounded-xl text-sm font-bold transition-colors">
                            Continue Learning
                          </button>
                        </div>
                      </div>
                    ...
                    <div className="bg-[var(--color-background-secondary)] rounded-[20px] overflow-hidden shadow-sm border border-[var(--color-border-light)] flex flex-col group hover:shadow-md transition-all cursor-pointer">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        <h4 className="text-[16px] font-bold text-[var(--color-text-primary)] mb-1 line-clamp-2">Data Science Fundamentals</h4>
                        <p className="text-xs text-[var(--color-text-tertiary)] mb-4">Dr. Michael Chen</p>
                        <div className="mt-auto">
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-xs font-bold text-[var(--color-text-tertiary)]">Progress</span>
                            <span className="text-xs font-bold text-[var(--color-text-primary)]">45% Complete</span>
                          </div>
                          <div className="w-full bg-[var(--color-border-light)] rounded-full h-1.5 mb-2 overflow-hidden">
                            <div className="bg-[#1e1632] h-1.5 rounded-full" style={{ width: '45%' }}></div>
                          </div>
                          <p className="text-xs text-[var(--color-text-secondary)] font-medium mb-4">14 of 32 lessons completed</p>
                          <button className="w-full bg-[#1e1632] hover:bg-[#2d245a] text-[#ffffff] py-2.5 rounded-xl text-sm font-bold transition-colors">
                            Continue Learning
                          </button>
                        </div>
                    ...
                    <div className="bg-[var(--color-background-secondary)] rounded-[20px] overflow-hidden shadow-sm border border-[var(--color-border-light)] flex flex-col group hover:shadow-md transition-all cursor-pointer">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        <h4 className="text-[16px] font-bold text-[var(--color-text-primary)] mb-1 line-clamp-2">Full Stack Web Development</h4>
                        <p className="text-xs text-[var(--color-text-tertiary)] mb-4">Alex Martinez</p>
                        <div className="mt-auto">
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-xs font-bold text-[var(--color-text-tertiary)]">Progress</span>
                            <span className="text-xs font-bold text-[var(--color-text-primary)]">0% Complete</span>
                          </div>
                          <div className="w-full bg-[var(--color-border-light)] rounded-full h-1.5 mb-2 overflow-hidden">
        ...
        <div className="bg-[var(--color-background-secondary)] p-6 rounded-xl w-[320px] shadow-xl">
          ...
          <div className="flex justify-between">
                  ...
                  <div className="bg-[var(--color-background-secondary)] p-6 rounded-[20px] shadow-sm border border-[var(--color-border-light)] flex flex-col h-full items-center">
                    ...
                    <div className="w-full mt-2">
                      <div className="flex justify-between items-center mb-6">
                        <ChevronLeft size={18} className="text-[var(--color-text-tertiary)] cursor-pointer hover:text-[var(--color-text-primary)] transition-colors" />
                        <span className="text-sm font-bold text-[var(--color-text-primary)]">May 2026</span>
                        <ChevronRight size={18} className="text-[var(--color-text-tertiary)] cursor-pointer hover:text-[var(--color-text-primary)] transition-colors" />
                      </div>
                      ...
                      <div className="grid grid-cols-7 gap-y-3 gap-x-2 text-center text-sm font-medium text-[var(--color-text-primary)]">
                        <div className="text-[var(--color-text-tertiary)]">26</div><div className="text-[var(--color-text-tertiary)]">27</div><div className="text-[var(--color-text-tertiary)]">28</div><div className="text-[var(--color-text-tertiary)]">29</div><div className="text-[var(--color-text-tertiary)]">30</div><div>1</div><div>2</div>
                  ...
                  <div className="bg-[var(--color-background-secondary)] p-6 rounded-[20px] shadow-sm border border-[var(--color-border-light)] flex flex-col h-full">
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="p-4 rounded-xl border border-[var(--color-border-light)] hover:border-purple-300 hover:shadow-sm transition-all cursor-pointer bg-purple-50/30">
                        <p className="text-sm font-bold text-[var(--color-text-primary)] mb-1">React Hooks Best Practices</p>
                        <p className="text-[11px] text-[var(--color-text-tertiary)] font-medium">Updated 2 hours ago</p>
                      </div>
                      <div className="p-4 rounded-xl border border-[var(--color-border-light)] hover:border-purple-300 hover:shadow-sm transition-all cursor-pointer">
                        <p className="text-sm font-bold text-[var(--color-text-primary)] mb-1">Python Data Structures</p>
                        <p className="text-[11px] text-[var(--color-text-tertiary)] font-medium">Updated yesterday</p>
                      </div>
                      <div className="p-4 rounded-xl border border-[var(--color-border-light)] hover:border-purple-300 hover:shadow-sm transition-all cursor-pointer">
                        <p className="text-sm font-bold text-[var(--color-text-primary)] mb-1">SQL Query Optimization</p>
                        <p className="text-[11px] text-[var(--color-text-tertiary)] font-medium">Updated 3 days ago</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {(activeView === "Wellness Hub" ) && (
              <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <h3 className="text-xl font-bold text-[var(--color-text-primary)]" style={{ fontFamily: "'OV Soge', sans-serif" }}>Evolve & Wellness</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-[var(--color-background-secondary)] p-6 rounded-[20px] shadow-sm border border-[var(--color-border-light)] flex flex-col h-full">
                    ...
                    <div className="relative w-full h-[180px] flex items-end justify-between pb-6 border-b border-[var(--color-border-light)]">
                      ...
                      <div className="relative z-10 flex flex-col items-center w-full group cursor-pointer">
                        ...
                        <span className="absolute bottom-[-24px] text-[10px] font-medium text-[var(--color-text-tertiary)]">Mon</span>
                      </div>
                      <div className="relative z-10 flex flex-col items-center w-full group cursor-pointer">
                        <div className="h-2 w-2 rounded-full bg-purple-500 mb-[75px] group-hover:scale-150 transition-transform"></div>
                        <span className="absolute bottom-[-24px] text-[10px] font-medium text-[var(--color-text-tertiary)]">Tue</span>
                      </div>
                      <div className="relative z-10 flex flex-col items-center w-full group cursor-pointer">
                        <div className="h-2 w-2 rounded-full bg-purple-500 mb-[35px] group-hover:scale-150 transition-transform"></div>
                        <span className="absolute bottom-[-24px] text-[10px] font-medium text-[var(--color-text-tertiary)]">Wed</span>
                      </div>
                      ...
                      <div className="relative z-10 flex flex-col items-center w-full group cursor-pointer">
                        ...
                        <span className="absolute bottom-[-24px] text-[10px] font-medium text-[var(--color-text-tertiary)]">Fri</span>
                      </div>
                      <div className="relative z-10 flex flex-col items-center w-full group cursor-pointer">
                        <div className="h-2 w-2 rounded-full bg-purple-500 mb-[105px] group-hover:scale-150 transition-transform"></div>
                        <span className="absolute bottom-[-24px] text-[10px] font-medium text-[var(--color-text-tertiary)]">Sat</span>
                      </div>
                      <div className="relative z-10 flex flex-col items-center w-full group cursor-pointer">
                        <div className="h-2 w-2 rounded-full bg-purple-500 mb-[55px] group-hover:scale-150 transition-transform"></div>
                        <span className="absolute bottom-[-24px] text-[10px] font-medium text-[var(--color-text-tertiary)]">Sun</span>
                      </div>
                    </div>
                    <p className="text-xs font-semibold text-[var(--color-text-tertiary)] mt-8">Total: 23.1 hours this week</p>
                  </div>
                  ...
                  <div className="bg-[var(--color-background-secondary)] p-6 rounded-[20px] shadow-sm border border-[var(--color-border-light)] flex flex-col h-full">
                    ...
                    <div className="flex flex-col gap-6 border-l-2 border-[var(--color-border-light)] ml-2 pl-5 relative mt-2">
                      ...
                      {/* Activity 3 */}
                      <div className="relative">
                        <div className="absolute -left-[27px] top-1 w-3 h-3 rounded-full bg-[#6b46c1] border-[3px] border-[#ffffff] shadow-sm box-content"></div>
                        <p className="text-sm font-bold text-[var(--color-text-primary)]">Stress Management</p>
                        <p className="text-xs text-[var(--color-text-tertiary)] font-medium mt-0.5">Scheduled</p>
                      </div>

                      {/* Activity 4 */}
                      <div className="relative opacity-50">
                        <div className="absolute -left-[27px] top-1 w-3 h-3 rounded-full bg-gray-300 border-[3px] border-[#ffffff] shadow-sm box-content"></div>
                        <p className="text-sm font-bold text-[var(--color-text-primary)]">Growth Mindset</p>
                        <p className="text-xs text-[var(--color-text-tertiary)] font-medium mt-0.5">Coming Up</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[var(--color-background-secondary)] p-6 rounded-[20px] shadow-sm border border-[var(--color-border-light)] flex flex-col h-full lg:col-span-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="flex flex-col items-center justify-center p-5 rounded-xl border border-[var(--color-border-light)] bg-gray-50/50 hover:bg-gray-50 hover:border-orange-200 transition-colors cursor-pointer group">
                        ...
                        <p className="text-sm font-bold text-[var(--color-text-primary)] text-center">7 Day Streak</p>
                      </div>
                      <div className="flex flex-col items-center justify-center p-5 rounded-xl border border-[var(--color-border-light)] bg-gray-50/50 hover:bg-gray-50 hover:border-emerald-200 transition-colors cursor-pointer group">
                        ...
                        <p className="text-sm font-bold text-[var(--color-text-primary)] text-center">Rising Star</p>
                      </div>
                      <div className="flex flex-col items-center justify-center p-5 rounded-xl border border-[var(--color-border-light)] bg-gray-50/50 hover:bg-gray-50 hover:border-blue-200 transition-colors cursor-pointer group">
                        ...
                        <p className="text-sm font-bold text-[var(--color-text-primary)] text-center">Goal Crusher</p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-xl border border-[var(--color-border-light)] hover:border-purple-500/30 hover:bg-purple-500/10 transition-all duration-200 cursor-pointer group hover:-translate-x-0.5">
            ...
            {![
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-[var(--color-text-primary)] mb-3" style={{ fontFamily: "'OV Soge', sans-serif" }}>
                  {activeView}
                </h3>
