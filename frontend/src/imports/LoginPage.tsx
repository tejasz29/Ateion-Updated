    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <div className="right-side">
          ...
          <button className="google-btn" onClick={handleGoogleLogin} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
          ...
          <button className="linkedin-btn" onClick={handleLinkedinLogin} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
          ...
          <button className="github-btn" onClick={handleGithubLogin} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
