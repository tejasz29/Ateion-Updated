    ...
    <div className="register-container">
      <div className="register-card">
        ...
        <div className="left-side">
          <h1>Join Ateion</h1>
          <p>
            Reimagining education with innovation, workshops and modern
            learning.
          </p>
        </div>
        ...
        <div className="right-side">
          ...
          <select
            ...
            onChange={(e) =>
              setFormData({ ...formData, ageSegment: e.target.value })
            }
            required
          >
            ...
            <option value="Segment 2 (Age 12-14)">
              Segment 2 (Ages 12-14)
            </option>
            <option value="Segment 3 (Age 15-17)">
              Segment 3 (Ages 15-17)
            </option>
            <option value="Segment 4 (Age 18-21)">
              Segment 4 (Ages 18-21)
            </option>
            <option value="Segment 5 (Professional)">
              Segment 5 (Professional / 22+)
            </option>
          </select>
