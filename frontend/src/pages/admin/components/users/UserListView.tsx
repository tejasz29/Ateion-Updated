    ...
    >
      <motion.div className="flex justify-between items-end mb-8" variants={itemVariants}>
        <div>
          ...
          />
          <h2 className="text-3xl font-bold font-['OV_Soge'] mb-2">User Management</h2>
          <p className="text-[var(--color-text-secondary)]">Manage students, instructors, and administrative accounts.</p>
        </div>
        <motion.button
      ...
      >
                ...
                paginated.map((user, i) => (
                  ...
                  >
                    <td className="p-4">
                      ...
                      >
                        {selectedIds.has(user.id) ? <CheckSquare size={16} /> : <Square size={16} />}
                      </button>
                    </td>
                    <td className="p-4">
        ...
        <div className="p-4 border-t border-[var(--color-border-light)] flex justify-between items-center text-sm text-[var(--color-text-secondary)] bg-[var(--color-background-secondary)]">
          <p>Showing 1 to {paginated.length} of {sorted.length} entries</p>
        ...
        {selectedIds.size > 0 && (
          ...
          >
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-[var(--color-background-tertiary)] hover:bg-emerald-500/10 text-[var(--color-text-secondary)] hover:text-emerald-500 text-sm font-medium flex items-center gap-1.5 transition-colors cursor-pointer"
            >
              <Archive size={14} />
              Activate
            </button>
